...
Abra a classe link:src/main/java/exercicios/Aula07.java[Aula07.java] e:
- implemente os métodos disponíveis lá - tais métodos devem ser implementados utilizando Streams e Lambdas;
- declare atributos para armazenar `Comparators` compostos; reutilize eles onde for necessário na classe.
