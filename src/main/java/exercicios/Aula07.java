...
public class Aula07 extends Aula {
         ...
         * Você deve trocar o valor armazenado ao atributo para ele seguir a regra
         * definida acima.
         */
        private final Predicate<Estudante> mulheresAprovadas = ((Predicate<Estudante>) Estudante::isMulher)
                        .and(Estudante::hasCurso)
                        .and(Estudante::isAprovado);// TODO: Atribua aqui o predicado composto com o filtro indicado
                                                    // acima

        /**
         * Você pode chamar os métodos existentes e outros que você criar aqui,
         * incluir prints e fazer o que desejar neste método para conferir os valores
         ...
         */
        public Aula07() {
                // TODO: Insira chamdas das funções existentes aqui, para você conferir como
                // estão funcionando
        }
         ...
         * em algum curso
         * O método usa o predicado {@link #mulheresAprovadas} para filtrar a lista de
         * estudantes.
         * Desta forma, você precisa definir um predicado composto com
         * {@link Predicate#and(Predicate)}
         * para tal atributo.
         *
         * @return uma Lista <b>NÃO-MODIFICÁVEL</b> de estudantes selecionados pelo
         *         predicado {@link #mulheresAprovadas}
         */
        ...
        /**
         * Obtém uma Lista com os mesmos filtros do método
         * {@link #getEstudantesMulheresAprovadas()},
         ...
         *
         * @return uma Lista <b>MODIFICÁVEL</b> de estudantes selecionados pelo
         *         predicado {@link #mulheresAprovadas}
         */
